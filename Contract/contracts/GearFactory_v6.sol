...
contract GearFactory_v6 is ERC1155, Ownable {
    ...
    function mintWeapon(address to, uint256 amount, WeaponLibrary.Weapon memory newWeapon) internal notEmptyWeapon(newWeapon) {
