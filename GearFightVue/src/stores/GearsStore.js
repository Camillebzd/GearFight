  ...
  actions: {
    ...
    getFightFormGear(tokenId) {
      ...
      return {
        ...
        life_base: parseInt(this.getGearAttributeInfo(tokenMetadata.attributes, "Life")),
        attack: parseInt(this.getGearAttributeInfo(tokenMetadata.attributes, "Strength")),
        attack_base: parseInt(this.getGearAttributeInfo(tokenMetadata.attributes, "Strength")),
        speed: parseInt(this.getGearAttributeInfo(tokenMetadata.attributes, "Speed")),
        speed_base: parseInt(this.getGearAttributeInfo(tokenMetadata.attributes, "Speed")),
        isNPC: false,
        played: false,
        action: {},
