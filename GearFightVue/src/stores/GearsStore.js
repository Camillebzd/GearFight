  ...
  actions: {
    ...
    getFightFormGear(tokenId) {
      ...
      return {
        ...
        level: 10, //parseInt(this.getGearAttributeInfo(tokenMetadata.attributes, "Level")),
        life: 10,//parseInt(this.getGearAttributeInfo(tokenMetadata.attributes, "Life")),
        life_base: 10,//parseInt(this.getGearAttributeInfo(tokenMetadata.attributes, "Life")),
        attack: 1,//parseInt(this.getGearAttributeInfo(tokenMetadata.attributes, "Strength")),
